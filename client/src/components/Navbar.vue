  ...
  <div>
    ...
    <b-container class="d-flex justify-content-center">
      <b-navbar
        variant="faded"
        type="light"
        style="border-bottom: 0.5px solid rgba(0,0,0,0.4); align-items: center"
      >
          ...
          <b-navbar-nav class="nav-items">
            ...
            >
              <b-dropdown-item
                ...
                @click.prevent="clickDashboardUser"
              >{{isUser.username}}</b-dropdown-item>
...
button#__BVID__15__BV_toggle_.btn.dropdown-toggle.btn-none.btn-sm {
